 ...
 */
export declare type BlogInfoInput = CommonInput;
/**
 * 블로그 컨텐츠 개수
 */
export declare type BlogInfoStatistics = {
    /**
     * 전체 게시글 개수
     */
    post: string;
 ...
 */
export declare type BlogInfoEachItem = {
    /**
     * 티스토리 도메인 기준 블로그 url
     */
    url: string;
 ...
 */
export declare type BlogInfoOutput = {
    item: {
        /**
         * 사용자의 로그인 아이디
         * 로그인 할 때 사용되는 아이디입니다.
...
//# sourceMappingURL=blog-info.d.ts.map