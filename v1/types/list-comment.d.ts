 ...
 * 특정 게시글 댓글목록 조회 입력
 */
export declare type ListCommentInput = CommonInput & {
    /**
     * 블로그 식별자
 ...
 */
export declare type ListCommentEachItem = {
    /**
     * 숫자 형태의 댓글 식별자
     */
    id: string;
 ...
 * 특정 게시글 댓글목록 조회 출력
 */
export declare type ListCommentOutput = {
    item: {
        /**
...
//# sourceMappingURL=list-comment.d.ts.map