 ...
 * 게시글 목록 조회 API 입력
 */
export declare type ListPostInput = CommonInput & {
    /**
     * 블로그 식별자
 ...
 */
export declare type ListPostEachItem = {
    /**
     * 숫자 기반의 게시글 식별자
     */
    id: string;
 ...
 * 게시글 수정 API 출력
 */
export declare type ListPostOutput = {
    item: {
        /**
         * 티스토리 도메인 기준 블로그 url
         */
...
//# sourceMappingURL=list-post.d.ts.map